...
class RTCWorkerClient:
    def __init__(
        ...
        # Initialize Worker I/O configuration (new simplified approach)
        ...
        # Initialize shared storage configuration (DEPRECATED - legacy support)
        try:
            ...
            if self.shared_storage_root:
                ...
                logging.info(
                    f"[DEPRECATED] Worker shared storage enabled: {self.shared_storage_root}"
                )
            else:
        ...
        if self.io_config:
            ...
            logging.info("Transfer mode: Legacy Shared Storage (deprecated)")
        else:
